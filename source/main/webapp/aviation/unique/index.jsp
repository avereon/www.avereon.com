...
aerodynamics.</p>
<ul>
	<li>Single Surface</li>
	<ul>
		<li>Delta Wing</li>
		<li>Flying Wing</li>
	</ul>
	<li>Multiple Surface</li>
	<ul>
		<li>Canard</li>
		<li>Tandem Wing</li>
		<li>Triple Surface</li>
	</ul>
	<li>Multiple Fuselage</li>
	<li>Wing in Ground Effect</li>
</ul>
</body>
