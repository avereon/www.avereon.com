...
<body>
<h1>Modeling</h1>
<p>One of the first tasks when modeling geometry with computers is to
determine how to represent geometry with computer data. At first this seems
simple but later on we will see how this is more involved than first thought.</p>
<h2>Space</h2>
<p>Lets start with the first thing that we need and that is the space that
we will use to describe shapes. Most of us are familiar with a space that does
not bend or twist. This type of space is called by mathematicians <a
	href="http://en.wikipedia.org/wiki/Euclidean_space">Euclidean space</a>, named
after the mathematician <a href="http://en.wikipedia.org/wiki/Euclid">Euclid</a>.
Euclidean space is sufficient to handle most computer applications and other
types of spaces are often transformed to Euclidean space for display.</p>
<h2>Coordinates</h2>
<p>In order to orient things in any space one needs to set up a system,
commonly called a coordinate system, to locate and orient shapes relative to one
