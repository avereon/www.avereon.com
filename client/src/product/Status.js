		...
		return (
			<div className='product-bar'>
				...
				<div className='body'>
					...
					<a href={'https://github.com/avereon/' + this.props.ident + '/actions/workflows/ci.yml'}>
						<img alt={this.props.name + " Build Status"} src={"https://github.com/avereon/" + this.props.ident + "/actions/workflows/ci.yml/badge.svg"}/>
					</a>
				</div>
			</div>
		)
